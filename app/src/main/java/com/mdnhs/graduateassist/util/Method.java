...
public class Method {
    ...
    public String getUserImageSmall() {
        return pref.getString(userImageSmall, "");
    }
    ...
    public void click(final int position, final String type, final String id, final String title) {
                                ...
                                public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                                    ...
                                    interstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                                        ...
                                        public void onAdFailedToShowFullScreenContent(@NonNull com.google.android.gms.ads.AdError adError) {
                                            ...
                                            onClick.click(position, type, id, title);
                                        }
    ...
    public void suspend(String message) {
        ...
        if (isLogin()) {
            ...
            String type_login = getLoginType();
            assert type_login != null;
